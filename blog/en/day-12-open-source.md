---
day: 12
title: "What 18 Million Installs Taught Me About Engineering at Scale"
pillar: Builder
language: en
...
I started contributing after using it extensively in production at several companies. The "I see how I'd improve this" impulse is what draws most OSS contributors in. You hit a limitation, you understand the codebase well enough to see a solution, and you decide to contribute the fix rather than maintain a local patch.
...
At Insly, this discipline directly improves how we design our internal APIs and integrations with third-party systems. When 150,000 documents per month depend on your platform, your API changes are their breaking changes.
...
Writing PRs to this standard has made me better at code review in my own team's work. I've applied the same standard to my team's code review culture at Insly: each PR should be a complete argument for a specific change, with enough context that a reviewer who doesn't know the feature can evaluate it correctly.
...
## Ruthlessness About Scope

There's a fifth lesson I've absorbed from observing good OSS maintainers: saying no is a feature.

A good open source maintainer says no more than yes. Every feature someone wants is a feature someone else will have to debug, document, and support for a decade. Scope creep in an OSS project is especially dangerous because the people proposing features often aren't the ones who will bear the maintenance burden.

I carry this into product decisions at Insly. The features we don't build are as important as the ones we do. Simplicity is a competitive advantage when your AI processes 150,000 documents per month and a 15-person team.
