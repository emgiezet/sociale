...
Not "can we test it" — can we measure whether it's actually good enough? This means defining what "good enough" looks like in advance: precision thresholds, recall targets, latency budgets, error rate limits.
