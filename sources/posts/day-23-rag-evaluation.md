...
In insurance, certain failure types are catastrophic: wrong coverage amounts, incorrect policy terms, fabricated legal references. We maintain a list of ~30 "canary questions," where any hallucination is a blocker. These run on every deployment.
