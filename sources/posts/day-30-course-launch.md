---
day: 30
title: "30 days ago I started sharing what I know about AI in production. Now I'm turning it into a course."
pillar: Educator
...
cta: DM 'COURSE' for early access + founder pricing
---

30 days ago I started sharing what I know about AI in production. Now I'm turning it into a course.
...
→ RAG from scratch to production: chunking strategies, retrieval evaluation, hallucination detection, the mistakes that cost us weeks
→ Agentic system design: how to build systems where AI takes meaningful actions without going off-script
→ Evaluation that actually works: the framework I use at Insly to gate every deployment
→ Compliance and auditability: how to build AI systems that survive a GDPR audit or a regulatory review
